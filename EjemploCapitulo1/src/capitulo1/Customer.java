...
class Customer {
	 ...
	 * 
	 * // Este es el nuevo método que se ha creado, // al pasar las pruebas por
	 * primera vez los test fallaban porque al generar // el nueno método
	 * devolvía entero en vez de double //Hemos refactorizado las variables
